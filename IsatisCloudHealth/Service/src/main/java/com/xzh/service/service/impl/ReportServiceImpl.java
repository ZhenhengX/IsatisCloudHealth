...
import com.xzh.service.dao.ReportDao;
...
public class ReportServiceImpl implements ReportService {
    ...
    public Map<String, Object> getBusinessReportData() throws Exception {
        ...
        //(当天)新增会员数
        Integer todayNewMember = memberDao.selectCount(Wrappers.lambdaQuery(Member.class).eq(Member::getRegTime, DateUtils.parseDate2String(new Date(), "yyyy-MM-dd")));
        //本周新增会员数
