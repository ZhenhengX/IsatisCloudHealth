...
import com.xzh.view.openFeign.AdviceFeign;
...
public class AdviceController {
    @Autowired
    private AdviceFeign adviceFeign;
    @Autowired
    ...
    public Result add(String suggestion, String[] foodIds, String[] sportIds, Integer orderId) {
        try {
            ...
            if (user != null) {
                ...
                AdviceDTO adviceDTO = new AdviceDTO(orderId, foodIds, sportIds, username, suggestion);
                adviceFeign.add(adviceDTO);//添加数据
            }
