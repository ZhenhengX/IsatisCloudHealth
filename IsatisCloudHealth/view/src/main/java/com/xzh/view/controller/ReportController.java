...
import com.xzh.view.openFeign.BusinessReportFeign;
import com.xzh.view.openFeign.MemberFeign;
import com.xzh.view.openFeign.ReportFeign;
...
public class ReportController {
    ...
    @Autowired
    private BusinessReportFeign businessReportService;
    @Autowired
    private ReportFeign reportService;
...
//                row.getCell(6).setCellValue(proportionubleValue());//占比
            }
