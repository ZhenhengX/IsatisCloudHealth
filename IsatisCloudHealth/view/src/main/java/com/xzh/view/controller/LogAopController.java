...
@Controller
@Configuration
@ComponentScan("com.xzh.view.controller")
@EnableAspectJAutoProxy
public class LogAopController {
    @Autowired
    private HttpServletRequest request;

    @Autowired //注意不同的项目下不能使用@Autowired  要是用@Autowired
    private ISysLogFeign service;
...
*/
    ...
    //后置通知
    @After("execution(* com.xzh.view.controller.*.*(..))")
    public void doAfter() {
        //4如何获取执行的时长?
